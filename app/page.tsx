  ...
  return (
    <main dir="rtl" className="relative min-h-screen overflow-hidden bg-blush-50 font-body">
      ...
      <div className="relative mx-auto max-w-4xl px-6 py-16 sm:py-24">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {links.map((link) => (
            ...
            >
              ...
              <h2 className="mb-2 font-display text-lg font-semibold text-wine-700">
                {link.label}
              </h2>
        ...
        <p className="mt-16 text-center text-xs text-plum-900/40">
          نظام داخلي لإدارة الطابور والحجوزات — عيادة النساء والولادة
        </p>
      </div>
    </main>
  );
